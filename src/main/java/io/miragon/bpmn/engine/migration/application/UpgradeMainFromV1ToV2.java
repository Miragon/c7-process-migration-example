...
public class UpgradeMainFromV1ToV2 {
    ...
    public void run() {
        final MigrationPlanFactory camundaMigrationPlanFactory = (source, target) -> runtimeService
        ...
        final VariableStep create_variable_numPieces = VariableStep.builder()
                .readStrategy(new ReadConstantValue(Variables.longValue(Long.valueOf(1L))))
                .writeStrategy(new WriteProcessVariable())
